...
bool ColorShaderClass::LineRender(ID3D11DeviceContext* deviceContext, int vertexCount,
	XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix)
{
	bool result;
	...
	// Now render the prepared buffers with the shader.
	RenderLineShader(deviceContext, vertexCount);
...
void ColorShaderClass::RenderLineShader(ID3D11DeviceContext* deviceContext, int vertexCount)
{
	// Set the vertex input layout.
	deviceContext->IASetInputLayout(m_layout);
